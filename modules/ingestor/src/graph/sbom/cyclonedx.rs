...
use serde_cyclonedx::cyclonedx::v_1_6::{Component, LicenseChoiceUrl};
...
pub struct Information<'a>(pub &'a serde_cyclonedx::cyclonedx::v_1_6::CycloneDx);
...
impl SbomContext {
    ...
    pub async fn ingest_cyclonedx<C: ConnectionTrait>(
        &self,
        mut sbom: serde_cyclonedx::cyclonedx::v_1_6::CycloneDx,
        connection: &C,
    ) -> Result<(), anyhow::Error> {
