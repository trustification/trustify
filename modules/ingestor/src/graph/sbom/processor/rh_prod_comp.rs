...
impl super::Processor for RedHatProductComponentRelationships {
    ...
    fn post(
        ...
        log::info!("Processing Red Hat inter-document relationships");
        ...
        log::info!("Top-level components: {top_level:?}");
        ...
        for rel in relationships.iter() {
            ...
            new_rels.push(package_relates_to_package::ActiveModel {
                ...
                left_node_id: Set(prod_node_id.to_string()),
                relationship: rel.relationship.clone(),
                right_node_id: Set(ext_comp_node_id),
            });
        }

        log::info!("New relationships to add: {new_rels:?}");
